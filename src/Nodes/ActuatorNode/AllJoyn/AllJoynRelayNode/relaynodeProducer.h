...
extern PCSTR c_relaynodeIntrospectionXml;

ref class relaynodeProducer;

public interface class IrelaynodeProducer
{
    event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class relaynodeProducer sealed : [Windows::Foundation::Metadata::Default] IrelaynodeProducer
{
public:
    relaynodeProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~relaynodeProducer();

    // The implementation of IrelaynodeService that will handle method calls and property requests.
    property IrelaynodeService^ Service
    {
        IrelaynodeService^ get() { return m_serviceInterface; }
        void set(IrelaynodeService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property relaynodeSignals^ Signals
    {
        relaynodeSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<relaynodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    ...
    IrelaynodeService^ m_serviceInterface;
